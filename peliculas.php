    ...
    <nav class="navbar navbar-default container col-xs-12 col-sm-12 col-md-8 col-lg-8 span8 centering" role="navigation" style="z-index: 10">
        ...
        <div  class="collapse navbar-collapse navbar-ex1-collapse span8 centering" id="menu">
            <ul class="nav navbar-nav">
                <li ><a href="peliculas.php" style="background-color: #000000;color:white;" class="enlaces">PELÍCULAS </a></li>
...
//It consults with which we show the movies
...
<div id="centro_pelis" class="row container-fluid col-md-10 col-sm-6 col-xs-12 centering">
    ...
    <?php
    //while action returns the value of all the rows that includes the consultation sql

    while($fila){
        $titulo=$fila['titulo'];
        $foto=$fila['foto'];
        $id=$fila['id_obra'];
        //i seng id to url whith the link
